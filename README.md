...
This mod adds chemistry to KSP by adding a lot of compounds, all periodic table elements, hundreds of alloys, and many other chemical (and not very chemical) resources to the game! Scroll all the way down to see the current resource counts. <br><br>
It also has some very unique features, including but not limited to:
